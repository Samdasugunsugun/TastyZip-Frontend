<template>
  <div class="mt-10">
    <div class="flex items-center mb-10 w-full">
      <button class="mr-4 rounded-full border p-2 flex items-center justify-center border-gray-400" @click="routeToHome">
        ...
        <div class="flex justify-between">
          ...
          <div class="flex items-center text-base">
            <div class="relative text-transparent">
              <div class="z-10 absolute overflow-hidden text-red-500" :style="{width: store.score * 20 + '%' }"><span>★</span><span>★</span><span>★</span><span>★</span><span>★</span></div>
              <div class="z-0 text-gray-200"><span>★</span><span>★</span><span>★</span><span>★</span><span>★</span></div>
            </div>
          </div>
        </div>
        <div class="flex justify-between text-base">
          <span>{{ store.address }}</span>
          <span class="text-gray-400 text-sm">{{ store.score }} / 5</span>
        </div>
      </div>
    </div>
